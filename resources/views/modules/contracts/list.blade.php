        ...
        function resetTable () {
            table = $('#user').DataTable({
                ...
                columns: [
                    ...
                    { name: 'renewal_number', defaultContent: '',data: 'renewal_number',bSortable: true},
                    { name: 'renewal_date', defaultContent: '',data: 'renewal_date',bSortable: true},
                    { name: 'salary_factor', defaultContent: '',data: 'salary_factor',bSortable: true},
                    { name: 'salary_id', defaultContent: '',data: 'salary.name',bSortable: true},
                ],
                columnDefs: [
                    {
                        targets:   0,
                    ...
                    },
                    {
                        ...
                        render: function(data,type, columns){
                             var url = "./hop-dong/cap-nhat/"+ columns.id;
